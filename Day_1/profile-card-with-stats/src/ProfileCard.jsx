...
const ProfileCard = () => {
  return (
    <div className="max-w-md mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200">
      {/* Header */}
      <div className="relative h-32 bg-gradient-to-r from-[#008751] via-white to-[#008751] rounded-t-3xl">
      ...
      <div className="px-8 pt-16 pb-8 text-center">
        {/* Name & Title */}
        <h2 className="text-2xl font-bold text-gray-900">Taiwo Oluwagbotemi</h2>
        ...
        <div className="mt-6 flex justify-between gap-4">
          <div className="flex-1 bg-green-50 rounded-xl py-4 shadow-inner border border-green-100">
            <h3 className="text-lg font-bold text-green-800">1.36M</h3>
            <p className="text-xs text-green-700 mt-1">Followers</p>
          </div>
          ...
          <div className="flex-1 bg-blue-50 rounded-xl py-4 shadow-inner border border-blue-100">
            <h3 className="text-lg font-bold text-blue-800">2.63M</h3>
            <p className="text-xs text-blue-700 mt-1">Likes</p>
          </div>
        </div>
        ...
        {/* Follow Button */}
        <button className="mt-6 w-full bg-[#008751] text-white py-2 px-6 rounded-full font-semibold shadow-lg hover:bg-green-700 transition">
          Follow
        </button>
      </div>
    </div>
